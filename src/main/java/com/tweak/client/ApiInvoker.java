...
import com.tweak.client.auth.Authentication;
import com.tweak.client.auth.ApiKeyAuth;
import com.tweak.client.auth.HttpBasicAuth;
import com.tweak.client.request.GetRequest;
import com.tweak.client.request.PostRequest;
import com.tweak.client.request.PutRequest;
import com.tweak.client.request.DeleteRequest;
import com.tweak.client.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
     ...
     INSTANCE.authentications.put("access_token", new ApiKeyAuth("query", "access_token"));
  ...
  */
  ...
  public Request<String> createRequest(String host, String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, String> formParams, String contentType, String[] authNames, Response.Listener<String> stringRequest, Response.ErrorListener errorListener) throws ApiException {
    ...
    {
      b.append(escapeString("access_token"));
      b.append("=");
      b.append(escapeString(this.accessToken));
      b.append("&");
    }
