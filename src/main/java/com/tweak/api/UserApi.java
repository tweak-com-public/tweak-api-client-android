...
public class UserApi {
  ...
  */
  public InlineResponse2002 userExistsGetUsersidExists (String id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
   ...
   * @param id Model id
  */
  public void userExistsGetUsersidExists (String id, final Response.Listener<InlineResponse2002> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 
   ...
   * @return InlineResponse2002
  */
  public InlineResponse2002 userExistsHeadUsersid (String id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
   ...
   * @param id Model id
  */
  public void userExistsHeadUsersid (String id, final Response.Listener<InlineResponse2002> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 
   ...
   * @return void
  */
  public void userPrototypeDestroyByIdAccessTokens (String id, String fk) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  ...
  // create path and map variables
  String path = "/Users/{id}/accessTokens/{fk}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString())).replaceAll("\\{" + "fk" + "\\}", apiInvoker.escapeString(fk.toString()));
   ...
   * Delete a related item by id for accessTokens.
   * 
   * @param id User id   * @param fk Foreign key for accessTokens
  */
  public void userPrototypeDestroyByIdAccessTokens (String id, String fk, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 
   ...
   * @return AccessToken
  */
  public AccessToken userPrototypeFindByIdAccessTokens (String id, String fk) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
   ...
   * @param id User id   * @param fk Foreign key for accessTokens
  */
  public void userPrototypeFindByIdAccessTokens (String id, String fk, final Response.Listener<AccessToken> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 
   ...
   * @return User
  */
  public User userPrototypeUpdateAttributesPatchUsersid (String id, User data) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = data;
  
      // verify the required parameter 'id' is set
      if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling userPrototypeUpdateAttributesPatchUsersid",
      new ApiException(400, "Missing the required parameter 'id' when calling userPrototypeUpdateAttributesPatchUsersid"));
      }
  ...
  */
  public void userPrototypeUpdateAttributesPatchUsersid (String id, User data, final Response.Listener<User> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = data;
  ...
  * 
   ...
   * @return User
  */
  public User userPrototypeUpdateAttributesPutUsersid (String id, User data) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = data;
  
      // verify the required parameter 'id' is set
      if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling userPrototypeUpdateAttributesPutUsersid",
      new ApiException(400, "Missing the required parameter 'id' when calling userPrototypeUpdateAttributesPutUsersid"));
      }
   ...
   * @param id User id   * @param data An object of model property name/value pairs
  */
  public void userPrototypeUpdateAttributesPutUsersid (String id, User data, final Response.Listener<User> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = data;
  ...
  * 
   ...
   * @return AccessToken
  */
  public AccessToken userPrototypeUpdateByIdAccessTokens (String id, String fk, AccessToken data) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = data;
   ...
   * Update a related item by id for accessTokens.
   * 
   * @param id User id   * @param fk Foreign key for accessTokens   * @param data 
  */
  public void userPrototypeUpdateByIdAccessTokens (String id, String fk, AccessToken data, final Response.Listener<AccessToken> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = data;
  ...
  * 
   ...
   * @return User
  */
  public User userReplaceById (String id, User data) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = data;
  
      // verify the required parameter 'id' is set
      if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling userReplaceById",
      new ApiException(400, "Missing the required parameter 'id' when calling userReplaceById"));
      }
  ...
  */
  public void userReplaceById (String id, User data, final Response.Listener<User> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = data;
  ...
  * 
   ...
   * @return User
  */
  public User userReplaceOrCreate (User data) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = data;
   ...
   * @param data Model instance data
  */
  public void userReplaceOrCreate (User data, final Response.Listener<User> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = data;
  ...
  */
  public InlineResponse2001 userUpdateAll (String where, User data) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = data;
  ...
  */
  public void userUpdateAll (String where, User data, final Response.Listener<InlineResponse2001> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = data;
  ...
  * 
   ...
   * @return User
  */
  public User userUpsertPatchUsers (User data) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = data;
   ...
   * @param data Model instance data
  */
  public void userUpsertPatchUsers (User data, final Response.Listener<User> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = data;
  ...
  * 
   ...
   * @return User
  */
  public User userUpsertPutUsers (User data) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = data;
   ...
   * @param data Model instance data
  */
  public void userUpsertPutUsers (User data, final Response.Listener<User> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = data;
